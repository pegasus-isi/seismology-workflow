...
\nVersion 2.0.2, by C.J. Ammon, Penn State
...
The "ok" value is one if no problems occurred, zero otherwise.\n"""
	...
	hi = array.array('i') # allocate the array for header ints
...
###############################################################################
#
# a convenience function to list common header values
#
